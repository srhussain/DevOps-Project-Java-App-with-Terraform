...
#   count             = length(var.public_subnets)
  vpc_id            = aws_vpc.main.id
  cidr_block        = var.public_subnets_bastion[0]
...
#   # count = length(var.public_subnets)  1 eip is enough not much
...
# #   count         = length(var.public_subnets)  1 NAT Gateway for Testing
